...
| Catppuccin Color | Pantone Color | Comparison |
| --- | --- | --- |
| Rosewater | Mangano Calcite (`13-1501 TCX` / `#F5D4CD`) | ![](./assets/frappe/rosewater-compare.webp) |
| Flamingo | Strawberry Cream (`13-2005 TCX` / `#F4C3C4`) | ![](./assets/frappe/flamingo-compare.webp) |
| Pink | Pirouette (`14-3205 TCX` / `#EDBEDC`) | ![](./assets/frappe/pink-compare.webp) |
| Mauve | Mauve Mist (`15-3207 TCX` / `#C49BD4`) | ![](./assets/frappe/mauve-compare.webp) |
| Red | Peach Blossom (`16-1626 TCX` / `#DE8286`) | ![](./assets/frappe/red-compare.webp) |
| Maroon | Pink Icing (`15-1717 TCX` / `#EEA0A6`) | ![](./assets/frappe/maroon-compare.webp) |
| Peach | Pumpkin (`14-1139 TCX` / `#F5A26F`) | ![](./assets/frappe/peach-compare.webp) |
| Yellow | Straw (`13-0922 TCX` / `#E0C992`) | ![](./assets/frappe/yellow-compare.webp) |
| Green | Jade Lime (`14-0232 TCX` / `#A1CA7B`) | ![](./assets/frappe/green-compare.webp) |
| Teal | Cool Caribbean (`14-5618 TCX` / `#7EC4B7`) | ![](./assets/frappe/teal-compare.webp) |
| Sky | Pure Pond (`14-4716 TCX` / `#9DCFD8`) | ![](./assets/frappe/sky-compare.webp) |
| Sapphire | Sky Blue (`14-4318 TCX` / `#8ABAD3`) | ![](./assets/frappe/sapphire-compare.webp) |
| Blue | Open Air (`15-3922 TCX` / `#94B2DF`) | ![](./assets/frappe/blue-compare.webp) |
| Lavender | Lavender Fields (`14-3935 TCX` / `#ACAED1`) | ![](./assets/frappe/lavender-compare.webp) |
| Text | Halogen Blue (`13-3920 TCX` / `#BDC6DC`) | ![](./assets/frappe/text-compare.webp) |
| Subtext 1 | Xenon Blue (`14-3949 TCX` / `#B7C0D7`) | ![](./assets/frappe/subtext1-compare.webp) |
| Subtext 0 | Baby Lavender (`16-3923 TCX` / `#A2A9D1`) | ![](./assets/frappe/subtext0-compare.webp) |
| Overlay 2 | Thistle Down (`16-3930 TCX` / `#9499BB`) | ![](./assets/frappe/overlay2-compare.webp) |
| Overlay 1 | Purple Impression (`17-3919 TCX` / `#858FB1`) | ![](./assets/frappe/overlay1-compare.webp) |
| Overlay 0 | Blue Ice (`17-3922 TCX` / `#70789B`) | ![](./assets/frappe/overlay0-compare.webp) |
| Surface 2 | Folkstone Gray (`18-3910 TCX` / `#626879`) | ![](./assets/frappe/surface2-compare.webp) |
| Surface 1 | Nightshadow Blue (`19-3919 TCX` / `#4E5368`) | ![](./assets/frappe/surface1-compare.webp) |
| Surface 0 | Odyssey Gray (`19-3930 TCX` / `#434452`) | ![](./assets/frappe/surface0-compare.webp) |
| Base | Overture (`19-3944 TCX` / `#343646`) | ![](./assets/frappe/base-compare.webp) |
| Mantle | Navy Blazer (`19-3923 TCX` / `#282D3C`) | ![](./assets/frappe/mantle-compare.webp) |
| Crust | Baritone Blue (`19-3812 TCX` / `#272836`) | ![](./assets/frappe/crust-compare.webp) |
